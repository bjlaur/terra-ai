...
I was focused on shipping features and didn't treat testing as a first-class requirement. I ran the existing tests, saw they passed, and assumed that meant everything was covered. I didn't audit which new code paths were actually being exercises.
